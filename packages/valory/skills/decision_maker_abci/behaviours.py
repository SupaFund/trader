...
"""This package contains the round behaviours of the decision_maker_abci."""
...
from packages.valory.skills.decision_maker_abci.behaviours.prediction import (
    PredictionBehaviour,
)
...
from packages.valory.skills.decision_maker_abci.composition import (
    DecisionMakerAbciApp,
)


class DecisionMakerRoundBehaviour(AbstractRoundBehaviour):
    """This behaviour manages the consensus stages for the decision maker."""

    initial_behaviour_cls = CheckBenchmarkingBehaviour
